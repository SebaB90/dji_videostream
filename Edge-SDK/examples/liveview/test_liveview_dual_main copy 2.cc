...
int main(int argc, char **argv) {
    ...
    ImageProcessor::Options fpv_image_processor_option = {.name = std::string("display1"),
                                       .alias = "FPVCamera", .userdata = fpv_liveview_sample};

    auto fpv_image_processor = CreateImageProcessor(fpv_image_processor_option);

    if (0 != InitLiveviewSample(
        fpv_liveview_sample, Liveview::kCameraTypePayload, (Liveview::StreamQuality)fpv_quality,
    ...
    if (argc == 4) {
        ...
        fpv_liveview_sample->SetCameraSource((edge_sdk::Liveview::CameraSource)3);
    }
...
//     //**************************************************************************************************** */
//     // create fpv liveview sample
//     // auto fpv_liveview_sample = std::make_shared<LiveviewSample>(std::string("PayloadCamera"));
...
//     //     fpv_liveview_sample->Start();
//     // }
//     auto payload_liveview_sampleT = std::make_shared<LiveviewSample>(std::string("PayloadCamera"));

//     StreamDecoder::Options decoder_optionT = {.name = std::string("ffmpeg")};
//     auto payload_stream_decoderT = CreateStreamDecoder(decoder_optionT);

//     ImageProcessor::Options payload_image_processor_optionT = {.name = std::string("display"),
//                                        .alias = "FPVCamera", .userdata = payload_liveview_sampleT};

//     auto payload_image_processorT = CreateImageProcessor(payload_image_processor_optionT);

//     if (0 != InitLiveviewSample(
//         payload_liveview_sampleT, Liveview::kCameraTypePayload, (Liveview::StreamQuality)payload_quality,
//         payload_stream_decoderT, payload_image_processorT)) {
//         ERROR("Init liveview sample failed");
//     } else {
//         payload_liveview_sampleT->Start();
//     }    
...
//         INFO("set camera soure: %d", src);
//         payload_liveview_sample->SetCameraSource((edge_sdk::Liveview::CameraSource)src);
//         payload_liveview_sampleT->SetCameraSource((edge_sdk::Liveview::CameraSource)3);
//     }
